 ...
 * OpenApi Operation methods and cross-reference with route information. By no means all OpenApi 3 spec is covered,
 * so this part will be adjusted based on use cases encountered.
 */
